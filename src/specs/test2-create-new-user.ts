...
describe(' test2: verify when all requried fields entered correctly > new user account is created ', async () => {
    ...
    let first_name        = "Jim";
    let last_name         = 'Johnston'
    let password          = "Test2024QA$";
    let confirm_password  = "Test2024QA$";
    let email : string
    ...
    it(' click Create and Account link: Create New Customer Account page > enter all required fields > click Create an Account button > verify account created successfully ', async () => {
